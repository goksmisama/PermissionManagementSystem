...
public interface IOrdersDao {
    ...
    @Results({
            ...
            @Result(property="orderDesc",column="orderDesc"),
            @Result(property="product",column="productId",one=@One(select="com.marui.dao.IProductDao.findById",fetchType=FetchType.EAGER)),
            @Result(property="member",column="memberId",one=@One(select="com.marui.dao.IMemberDao.findById",fetchType=FetchType.EAGER)),
            @Result(property="travellers",column="id",many=@Many(select="com.marui.dao.ITravellerDao.findById",fetchType=FetchType.LAZY))
    })
